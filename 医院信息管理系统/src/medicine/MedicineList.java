...
public class MedicineList extends JFrame {
	...
	public MedicineList() {
		...
		btnNewButton.setBounds(456, 438, 93, 23);
		...
		btnNewButton_1.setBounds(456, 493, 93, 22);
		...
		btnNewButton_2.setFont(new Font("华文楷体", Font.PLAIN, 19));
		btnNewButton_2.setBounds(632, 438, 93, 23);
		...
		btnNewButton_3.setBounds(632, 493, 93, 22);
	...
	protected void editButton(ActionEvent e) {
		...
		me.setMeid(dtm.getValueAt(this.table.getSelectedRow(), 0).toString());
		me.setMename(dtm.getValueAt(this.table.getSelectedRow(), 1).toString());
		me.setPrice((float)dtm.getValueAt(this.table.getSelectedRow(), 2));
		me.setFirm( dtm.getValueAt(this.table.getSelectedRow(), 3).toString());
		me.setType(dtm.getValueAt(this.table.getSelectedRow(), 4).toString());
		me.setWaid((String) dtm.getValueAt(this.table.getSelectedRow(), 5));
		me.setPrice1((float)dtm.getValueAt(this.table.getSelectedRow(), 6) );
		me.setSnumber((int)dtm.getValueAt(this.table.getSelectedRow(), 7));
		addMedicine am=new addMedicine();
		am.editMedicne(me);
		am.setVisible(true);
		QueryAll();
